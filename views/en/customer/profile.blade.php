...
@section('customer-contents')
    ...
    <div class="box">
        ...
        @if(file_exists(PUBLICPATH . '/img/users/' . $customer->user->user_id . '.jpg'))
            <img class="float-right my-5 rounded-circle" style="max-width: 256px;" src="{{ BASEURL }}/img/users/{{ $customer->user->user_id }}.jpg">
        @else
            <img class="float-right my-5 rounded-circle" style="max-width: 256px;" src="{{ BASEURL }}/img/users/default.jpg">
        @endif
