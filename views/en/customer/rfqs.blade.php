        ...
        @foreach ($rfqs as $rfq)
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="{{ BASEURL }}/customers/rfqs.php?action=delete&rfq_id={{ $rfq->id }}" style="color: #ff0000;" title="Delete RFQ" onclick="return confirm('Are you sure you want to delete the RFQ: {{ $rfq->title }}');"><i class="far fa-trash-alt"></i></a>
                </td>
            </tr>
