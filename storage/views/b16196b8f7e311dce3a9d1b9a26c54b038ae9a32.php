...
<div class="box">
    ...
    <form action="<?php echo e(SELF); ?>?action=new&freelancer_id=<?php echo e($freelancer->id); ?>" method="post">
        ...
        <p>for <strong><?php echo e($freelancer->firstname); ?> <?php echo e($freelancer->lastname); ?></strong></p>
