<?php $__env->startSection('title'); ?> New Proposal <?php $__env->stopSection(); ?>
...
<div class="box">
    ...
    <form action="<?php echo e(SELF); ?>?action=new&customer_id=<?php echo e($customer->id); ?>" method="post">
        ...
        <p>for <strong><?php echo e($customer->name); ?></strong></p>
        ...
        <div class="form-group">
            ...
            <input type="number" name="validity" class="form-control" id="validity" value="<?php echo e($validity); ?>">
        </div>
        <div class="form-group">
