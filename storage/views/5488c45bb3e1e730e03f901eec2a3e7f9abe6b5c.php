...
<div class="box">
    ...
    <table class="table table-hover">
        ...
        <?php $__currentLoopData = $contracts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $contract): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <tr>
                <td><a href="<?php echo e(BASEURL); ?>/customers/contract.php?contract_id=<?php echo e($contract->id); ?>"><?php echo e($contract->proposal->title); ?></a></td>
                <td><a href="<?php echo e(BASEURL); ?>/freelancer.php?freelancer_id=<?php echo e($contract->proposal->freelancer_id); ?>"><?php echo e($contract->proposal->freelancer->firstname); ?> <?php echo e($contract->proposal->freelancer->lastname); ?></a></td>
