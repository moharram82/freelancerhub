...
<div class="box">
    ...
    <table class="meta-data">
        <tr>
            <td>Developer</td>
            <td class="data"><a href="<?php echo e(BASEURL); ?>/freelancers/freelancer.php?freelancer_id=<?php echo e($contract->proposal->freelancer_id); ?>"><?php echo e($contract->proposal->freelancer->firstname); ?> <?php echo e($contract->proposal->freelancer->lastname); ?></a></td>
        </tr>
        <tr>
            <td>Start</td>
