...
<div class="box">
    ...
    <table class="meta-data">
        <tr>
            <td>Developer</td>
            <td class="data"><a href="<?php echo e(BASEURL); ?>/freelancer.php?freelancer_id=<?php echo e($proposal->freelancer_id); ?>"><?php echo e($proposal->freelancer->firstname); ?> <?php echo e($proposal->freelancer->lastname); ?></a></td>
        </tr>
        <tr>
            <td>Delivery</td>
