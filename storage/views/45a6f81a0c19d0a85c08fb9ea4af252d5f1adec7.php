            ...
            <div class="sidebar">
                <div class="sidebar-section">
                    ...
                    <ul class="section-nav">
                        ...
                        <li><a href="<?php echo e(BASEURL); ?>/freelancers/projects.php"><i class="fas fa-project-diagram"></i> Projects</a></li>
                ...
                <div class="sidebar-section">
                    ...
                    <ul class="section-nav">
                        ...
                        <li><a href="<?php echo e(BASEURL); ?>/freelancers/profile.php"><i class="fas fa-address-card"></i> Edit Profile</a></li>
