...
<div class="box">
    ...
    <table class="table table-hover">
        ...
        <?php $__currentLoopData = $rfqs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rfq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <tr>
                <td><a href="<?php echo e(BASEURL); ?>/admin/rfq.php?rfq_id=<?php echo e($rfq->id); ?>"><?php echo e($rfq->title); ?></a></td>
                ...
                <td>
                    ...
                    <a href="<?php echo e(BASEURL); ?>/admin/rfqs.php?action=delete&rfq_id=<?php echo e($rfq->id); ?>" style="color: #ff0000;" title="Delete RFQ" onclick="return confirm('Are you sure you want to delete the RFQ: <?php echo e($rfq->title); ?>');"><i class="far fa-trash-alt"></i></a>
                </td>
            </tr>
