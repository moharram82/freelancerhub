    ...
    <table class="table table-hover">
        ...
        <tbody>
            ...
            <?php $__currentLoopData = $proposals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $proposal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <tr>
                    <td><a href="<?php echo e(BASEURL); ?>/customers/proposal.php?proposal_id=<?php echo e($proposal->id); ?>"><?php echo e($proposal->title); ?></a></td>
                    <td><a href="<?php echo e(BASEURL); ?>/freelancer.php?freelancer_id=<?php echo e($proposal->freelancer_id); ?>"><?php echo e($proposal->freelancer->firstname); ?> <?php echo e($proposal->freelancer->lastname); ?></a></td>
